...
async def scared(ctx):
    author = ctx.message.author
    embed = discord.Embed(description="{} is scared  ".format(author.mention), title="1,2,Freedys coming for you,better hide under your bed before he comes", color=0x57d2cc)
